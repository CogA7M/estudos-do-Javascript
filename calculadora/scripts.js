...
function atualizaDisplay(calculadora) {
  calculadora.bufferTextoElemento.innerText = calculadora.operandoAnterior + " " + calculadora.operador.replace("/","÷");
...
function escolheOperador(calculadora, operador) {
  if (calculadora.operandoAtual == "" && calculadora.operador == "") return

  if (calculadora.operandoAtual == "" && calculadora.operador != "") {
  ...
  calculadora.operador = operador;
  calculadora.operador = calculadora.operador.replace("÷", "/")
  // if (calculadora.operador == "÷") calculadora.operador = "/"
  // calculadora.operador = (operador == "÷" ? "/" : calculadora.operador)
...
function executaCalculo(calculadora) {
  ...
  let resultado = eval((calculadora.operandoAnterior)  + (calculadora.operador) + (calculadora.operandoAtual))
  calculadora.operandoAnterior = ""
